...
2. 发现vue/cli 3.0构建的项目在热更新中有点问题。pc端是没有问题的，但是在移动端打开项目后，每次修改触发热更新后，界面是会变化，但是如果你刷新页面后，页面又回到了起始项目运行的界面，即界面收到HMR的hash是最初的hash，并不是最新的hash，不知道具体是什么问题，我构建的vue-cli 2.0是没有该问题的。
3. 吐槽最近的github总是抽筋！！！
